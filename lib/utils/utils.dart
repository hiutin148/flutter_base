...
class Utils {
  ...
  static bool isURL(String input) {
    ...
    const urlRegex = r'^(https?|ftp):\/\/[^\s/$.?#].[^\s]*$';
    // Create a regular expression object
    final regex = RegExp(urlRegex, caseSensitive: false);
  ...
  static String? getHexFromColor(Color color) {
    final colorString = color.toString(); // Color(0x12345678)
